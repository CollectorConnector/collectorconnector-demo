...
export default function CollectionDetails() {
  ...
  async function loadCollectionData(uid: string) {
    try {
      ...
      // Load items that belong to this collection OR have no collection assigned
      ...
      if (itemError) console.error("Item load error:", itemError);
    ...
    <div style={{ minHeight: "100vh", background: "#000", color: "#fff" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "40px" }}>
          ...
          <div style={{ display: "inline-block", background: "#18181b", padding: "6px 16px", borderRadius: "20px", border: "1px solid #27272a" }}>
            <p style={{ color: "#818cf8", fontWeight: "900", fontSize: "12px", letterSpacing: "1px", margin: 0 }}>
              ...
              {items.reduce((sum, i) => sum + (Number(i.estimated_value) || 0), 0)}
            </p>
          </div>
        </div>
      ...
      {selectedItem && (
        ...
        >
          ...
          <button onClick={showPrev} style={{ position: "absolute", left: "20px", background: "rgba(255,255,255,0.1)", border: "none", color: "#fff", fontSize: "24px", padding: "20px", borderRadius: "50%", cursor: "pointer" }}>
            ‹
          </button>
          <button onClick={showNext} style={{ position: "absolute", right: "20px", background: "rgba(255,255,255,0.1)", border: "none", color: "#fff", fontSize: "24px", padding: "20px", borderRadius: "50%", cursor: "pointer" }}>
            ›
          </button>
          ...
          <div onClick={(e) => e.stopPropagation()} style={{ width: "100%", maxWidth: "400px", background: "#18181b", borderRadius: "24px", padding: "20px", border: "1px solid "#27272a" }}>
            ...
            <div style={{ display: "flex", gap: "10px", marginTop: "15px" }}>
              ...
              />
              <button onClick={() => { alert("Commented!"); setCommentText(""); }} style={{ background: "#fff", color: "#000", padding: "0 20px", borderRadius: "12px", fontWeight: "bold" }}>
                SEND
              </button>
            </div>
          </div>
