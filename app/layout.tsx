...
/* ───────────────────────────────────────────────
   HEADER — NO LOGO, NO AVATAR, FULL‑WIDTH, DESKTOP‑FIRST
   ─────────────────────────────────────────────── */
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-black/90 backdrop-blur-xl border-b border-white/10">
        <div className="w-full px-8">
          <div className="flex h-16 items-center justify-between gap-8">
            {/* LEFT: brand text only + pills */}
            <div className="flex items-center gap-8">
              <div className="leading-tight">
                <div className="text-sm font-semibold tracking-wide text-white">COLLECTORCONNECTOR</div>
                <div className="text-[11px] text-zinc-500">A home for collectors</div>
              </div>
            ...
            {/* CENTER: socials (correct set) */}
            <div className="flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1">
              <HeaderPill href="https://www.ebay.co.uk" label="eBay" subtle />
              <HeaderPill href="https://www.instagram.com" label="Instagram" subtle />
              <HeaderPill href="https://discord.com" label="Discord" subtle />
              <HeaderPill href="https://x.com" label="X" subtle />
              <HeaderPill href="https://www.whatnot.com" label="Whatnot" subtle />
            </div>

            {/* RIGHT: empty for balance (no avatar, no logo) */}
...
/* Reusable pill button (monochrome) */
function HeaderPill({
  href,
  label,
  active = false,
...
/* Small subcomponents for the lower sections */
