  ...
  return (
    ...
    >
      ...
      <div style={{ marginLeft: "auto", display: "flex", gap: 14 }}>
        <Link href="/" style={{ color: TEXT_PRIMARY, textDecoration: "none" }}>
          Home
        </Link>
        <Link href="/upload" style={{ color: TEXT_PRIMARY, textDecoration: "none" }}>
          Upload
        </Link>
      </div>
    </nav>
    ...
    >
      ...
      >
        ...
        <div style={{ marginLeft: "auto", display: "flex", gap: 12 }}>
          <Link href="/terms" style={{ color: TEXT_SECONDARY, textDecoration: "none" }}>
            Terms
          </Link>
          <Link href="/privacy" style={{ color: TEXT_SECONDARY, textDecoration: "none" }}>
            Privacy
          </Link>
          <Link href="/cookies" style={{ color: TEXT_SECONDARY, textDecoration: "none" }}>
            Cookies
          </Link>
          <Link href="/guidelines" style={{ color: TEXT_SECONDARY, textDecoration: "none" }}>
            Guidelines
          </Link>
        </div>
      </div>
