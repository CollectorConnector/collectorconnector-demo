...
const FixedEbayLogo = () => (
  <svg width="45" height="18" viewBox="0 0 538 217" xmlns="http://www.w3.org/2000/svg">
    <path fill="#e53238" d="M102.3 118.9c0 14.3-1.9 26.6-5.8 36.8-3.9 10.3-9.5 18.8-16.7 25.5-7.2 6.7-15.9 11.7-26.1 15-10.2 3.3-21.7 5-34.4 5-6.6 0-12.8-.4-18.7-1.1V15h20.6c11.9 0 22.3 1.7 31.4 5.1 9.1 3.4 16.6 8.3 22.5 14.8s10.3 14.3 13.2 23.4c2.9 9.1 4.3 19.3 4.3 30.6h.1v30zm-24.8-31c0-15.7-2.9-27.4-8.8-35.1-5.9-7.7-14.7-11.6-26.4-11.6h-2.1v96.2h3.3c11.6 0 20.3-3.9 26.2-11.7s8.8-21.1 8.8-40v2.2z"/>
    <path fill="#0064d2" d="M192.3 201.2h-21.7v-13.6c-4.3 4.9-9.9 8.8-16.7 11.6s-14.3 4.3-22.5 4.3c-11.1 0-20.7-2.3-28.7-6.8-8-4.5-14.4-10.8-19.1-18.9-4.7-8.1-8.1-17.5-10.1-28.2-2-10.7-3-22.2-3-34.6 0-12.7 1-24.3 3-34.9s5.3-19.8 10.1-27.8c4.8-8 11.2-14.1 19.1-18.4s17.3-6.5 28.1-6.5c17.5 0 31.1 5.9 41 17.6V15h21.6v186.2zm-22.7-86.4c0-17.5-3-31.1-8.9-40.8s-14.7-14.6-26.2-14.6c-11.6 0-20.3 4.8-26.3 14.4-6 9.6-9.1 23.4-9.1 41.3 0 17.8 3 31.5 8.9 41.1s14.6 14.4 26 14.4c11.6 0 20.5-4.8 26.6-14.4 6.2-9.6 9-23.4 9-41.4z"/>
    <path fill="#f5af02" d="M306.9 201.2h-21.5v-13.6c-4.4 5.1-10.2 9.1-17.3 12-7.1 2.9-14.9 4.3-23.4 4.3-8.8 0-16.7-1.5-23.7-4.4-7-2.9-13-7.1-17.9-12.6-4.9-5.5-8.7-12.2-11.3-20.2-2.6-8-3.9-17-3.9-27.1 0-10.2 1.3-19.2 4-27.1s6.6-14.4 11.7-19.5c5.1-5.1 11.3-9 18.6-11.7 7.3-2.7 15.6-4 25-4 17.4 0 30.9 5.8 40.5 17.5V81.1h21.6l-1.4 120.1zm-21.4-86.5c0-17.5-2.9-31.1-8.8-40.8s-14.6-14.6-26.2-14.6c-11.3 0-20 4.8-26 14.4-6 9.6-9.1 23.5-9.1 41.6 0 17.8 3 31.6 9 41.3 6 9.7 14.7 14.6 26.1 14.6 11.4 0 20.2-4.9 26.3-14.6 6.1-9.7 8.7-23.6 8.7-41.9z"/>
    <path fill="#86b817" d="M394.3 81.1l-40.5 106c-3.1 8-6.9 14.3-11.5 18.9s-10.2 7.9-16.9 9.8c-6.7 1.9-14.4 2.8-23.2 2.8-5.3 0-10.1-.3-14.3-.9v-19.1c3.2.6 6.5.9 9.9.9 10.9 0 18.7-3.6 23.4-10.9l4.5-8.8-44-108.8h23.2l31.1 81.7 30.8-81.7h23.5z"/>
  </svg>
);
