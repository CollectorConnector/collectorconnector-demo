      ...
      <main className="pt-8 pb-20 space-y-10 max-w-[720px] mx-auto px-4">
        ...
        <section className="bg-zinc-950 border border-zinc-800 rounded-2xl p-10 shadow-lg shadow-black/30">
          <div className="flex flex-col items-center text-center">
            ...
            {/* ULTRA-LOCKED SMALL AVATAR - 64px, same scale as tier icon */}
            <div className="relative mb-8">
              <div className="w-16 h-16 mx-auto overflow-hidden rounded-[30%] border-4 border-zinc-700 shadow-xl">
                <img
                  ...
                  alt="Avatar"
                  className="w-full h-full object-cover block"  {/* block + object-cover forces it down */}
                />
              </div>
              ...
              {isOwnProfile && (
                <label
                  ...
                  className="absolute -bottom-1 -right-1 bg-zinc-900 hover:bg-zinc-800 p-1.5 rounded-xl shadow-lg cursor-pointer"
                >
        ...
        {/* STATS, COLLECTIONS, RECENT DROPS remain the same as before */}
    ...
    <>
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 20, color: "white" }}>
          {/* Instagram, Facebook, eBay, Discord, Whatnot, X - all your icons are here */}
