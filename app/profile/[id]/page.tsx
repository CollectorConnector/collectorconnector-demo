...
export default function ProfilePage() {
  ...
  useEffect(() => {
    ...
    async function loadCollections() {
      const { data, error } = await supabase
        ...
        .eq("user_id", userId);
      console.log("Collections loaded:", data?.length || 0, "Error:", error);
  ...
  useEffect(() => {
    async function loadRecentDrops() {
      ...
      if (error) console.error("Recent drops error:", error);
      ...
      <main className="pt-8 pb-20 space-y-10 max-w-[720px] mx-auto px-4">
        ...
        <section className="bg-zinc-950 border border-zinc-800 rounded-2xl p-10 shadow-lg shadow-black/30">
          <div className="flex flex-col items-center text-center">
            {/* Exact Squircle Avatar from your reference */}
            <div className="relative mb-8">
              {isOwnProfile ? (
                ...
                >
                  <div
                    className="mx-auto w-24 h-24 overflow-hidden border-4 border-white shadow-2xl"
        ...
        <section className="bg-zinc-950 border border-zinc-800 rounded-2xl p-10 shadow-lg shadow-black/30">
          ...
          {recentDrops.length > 0 && (
            <div className="text-center mt-8 text-zinc-400 text-sm">
              Real-time uploads from the CollectorConnector community
            </div>
          )}
        </section>
      </main>
