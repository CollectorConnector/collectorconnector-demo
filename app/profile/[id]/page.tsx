...
export default function ProfilePage() {
  ...
  // RESIZE ON UPLOAD - this is what FB/Instagram do
  async function handleAvatarChange(e: ChangeEvent<HTMLInputElement>) {
    ...
    try {
      const resizedFile = await resizeImage(file, 300); // max 300px wide/high
  ...
  // Resize helper (client-side, like FB/Instagram)
      ...
      <main className="pt-8 pb-20 space-y-10 max-w-[720px] mx-auto px-4">
        ...
        <section className="bg-zinc-950 border border-zinc-800 rounded-2xl p-10 shadow-lg shadow-black/30">
          <div className="flex flex-col items-center text-center">
            ...
            {/* SMALL AVATAR - 64px, clean and independent */}
            <div className="relative mb-8">
              <div className="mx-auto w-16 h-16 aspect-square overflow-hidden rounded-[30%] border-4 border-zinc-700 shadow-xl">
                <img
        ...
        {/* STATS, COLLECTIONS, RECENT DROPS */}
        <section className="bg-zinc-950 border border-zinc-800 rounded-2xl p-10 shadow-lg shadow-black/30">
    ...
    <>
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 20, color: "white" }}>
          {/* Instagram, Facebook, eBay, Discord, Whatnot, X - all here */}
        </div>
      </header>
      <div style={{ height: 56 }} />
    </>
