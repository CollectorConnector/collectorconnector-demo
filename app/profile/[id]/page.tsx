...
export default function ProfilePage() {
  ...
  // RESIZE IMAGE ON UPLOAD - this fixes the massive size forever
  async function handleAvatarChange(e: ChangeEvent<HTMLInputElement>) {
    ...
    try {
      const resizedFile = await resizeImage(file, 300); // max 300px
      ...
      <main className="pt-8 pb-20 space-y-10 max-w-[720px] mx-auto px-4">
        ...
        <section className="bg-zinc-950 border border-zinc-800 rounded-2xl p-10 shadow-lg shadow-black/30">
          <div className="flex flex-col items-center text-center">
            ...
            {/* STRICT 64px AVATAR - centred, same size for every user */}
    ...
    <>
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 20, color: "white" }}>
          {/* Instagram, Facebook, eBay, Discord, Whatnot, X icons - all restored */}
