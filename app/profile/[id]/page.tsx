...
export default function ProfilePage() {
  ...
  async function loadAllData() {
    try {
      ...
      // FIXED: Now fetches profile id so we can link to it
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <main style={{ marginTop: '100px', paddingBottom: '80px', maxWidth: '800px', margin: '100px auto 0', padding: '0 16px', display: 'flex', flexDirection: 'column', gap: '24px' }}>
        ...
        {/* GLOBAL RECENT DROPS - FIXED WITH CLICKABLE @ */}
      ...
      {/* LIGHTBOX - with clickable username */}
      ...
      {/* MODALS - all your original modals unchanged */}
      {showAddCollection && (
