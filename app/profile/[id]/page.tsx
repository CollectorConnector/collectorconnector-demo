...
export default function ProfilePage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-black text-white flex items-center justify-center font-black">
        SYNCING VAULT...
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-black text-white" style={{ background: '#000' }}>
      ...
      <main style={{ 
        ...
        <section style={{ 
          ...
          <p style={{ color: '#818cf8', fontSize: '18px', marginBottom: '16px' }}>
            @{profile?.username}
          </p>
          <p style={{ color: '#a1a1aa', fontSize: '16px', marginBottom: '24px', maxWidth: '400px' }}>
            {profile?.bio || "Digital Vault Explorer."}
          </p>
        ...
        <section style={{ 
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px', textAlign: 'center' }}>
            <div>
              <p style={{ fontSize: '22px', fontWeight: '900' }}>{itemCount}</p>
              <p style={{ color: '#52525b', fontSize: '11px', fontWeight: 'bold' }}>ITEMS</p>
            </div>
            <div>
              <p style={{ fontSize: '22px', fontWeight: '900' }}>{collectionCount}</p>
              <p style={{ color: '#52525b', fontSize: '11px', fontWeight: 'bold' }}>COLLS</p>
            </div>
            <div>
              <p style={{ fontSize: '22px', fontWeight: '900', color: '#4ade80' }}>
                £{vaultValue.toLocaleString()}
              </p>
              <p style={{ color: '#52525b', fontSize: '11px', fontWeight: 'bold' }}>VALUE</p>
            </div>
          </div>
        </section>
        ...
        <section style={{ 
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px' }}>
            {recentDrops.length > 0 ? (
              ...
              <p style={{ gridColumn: 'span 3', textAlign: 'center', color: '#52525b', padding: '20px' }}>
                Vault is empty.
              </p>
            )}
          </div>
          ...
          <div style={{ 
            ...
            <div style={{ display: 'flex', gap: '12px' }}>
              <button 
                ...
                style={{ flex: 1, color: '#a1a1aa', fontWeight: 'bold', background: 'none', border: 'none' }}
              >
                CANCEL
              </button>
              <button 
          ...
          <div style={{ 
            ...
            {!preview ? (
              ...
              <div style={{ position: 'relative', marginBottom: '15px' }}>
                <img src={preview} style={{ width: '100%', borderRadius: '12px' }} alt="Preview" />
              </div>
            )}
