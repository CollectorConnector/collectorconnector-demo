...
const FounderIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ marginLeft: '4px' }}>
    <path d="M12 2L15.09 8.26L22 9.27L17 14.14L18.18 21.02L12 17.77L5.82 21.02L7 14.14L2 9.27L8.91 8.26L12 2Z" fill="#FFD700" stroke="#DAA520" strokeWidth="2" strokeLinejoin="round"/>
  </svg>
);
...
export default function ProfilePage() {
  ...
  async function determineRank() {
    ...
    // Fixed logic for Founders IDs including Richard's UID
    const foundersIds = [
        "e0759f79-d113-4af6-a575-cee076037092", 
        "bb088a77-ba12-4fe3-a357-03d13dc0d019" // Richard's UID
    ];
      ...
      <main style={{ marginTop: '100px', paddingBottom: '80px', maxWidth: '800px', margin: '100px auto 0', padding: '0 16px', display: 'flex', flexDirection: 'column', gap: '24px' }}>
        ...
        <section style={{ background: '#09090b', border: '1px solid #27272a', borderRadius: '24px', padding: '32px', textAlign: 'center', position: 'relative' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', justifyContent: 'center', flexWrap: 'wrap' }}>
              ...
              {userRank === "founder" ? <FounderIcon /> : renderRankIcon()}
