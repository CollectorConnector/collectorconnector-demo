      ...
      <main className="pt-8 pb-20 space-y-10 max-w-[720px] mx-auto px-4">
        ...
        <section className="bg-zinc-950 border border-zinc-800 rounded-2xl p-10 shadow-lg shadow-black/30">
          <div className="flex flex-col items-center text-center">
            ...
            {/* STRICT 64px AVATAR WITH ASPECT RATIO */}
            <div className="relative mb-8">
              <div 
                className="w-16 h-16 mx-auto overflow-hidden rounded-[30%] border-4 border-zinc-700 shadow-xl aspect-square"
    ...
    <>
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 20, color: "white" }}>
          {/* Your social icons - Instagram, Facebook, eBay, Discord, Whatnot, X */}
          {/* (same as before) */}
        </div>
      </header>
      <div style={{ height: 56 }} />
