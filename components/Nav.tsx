...
export default function Nav() {
  return (
    <header className="w-full bg-black border-b border-gray-800 shadow-[0_0_40px_rgba(255,255,255,0.15)] fixed top-0 left-0 z-50">
      <div className="w-full flex items-center justify-between px-4 py-3 overflow-x-auto">

        {/* LEFT CLUSTER — allow it to stretch */}
        ...
        {/* RIGHT CLUSTER — push to the edge */}
        <nav className="flex items-center gap-4 text-sm justify-end whitespace-nowrap">
